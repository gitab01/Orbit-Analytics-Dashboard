  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-brand-50 dark:from-brand-500/10 via-white dark:via-gray-900 to-white dark:to-gray-900 border border-brand-200 dark:border-brand-500/20 rounded-xl p-6 sm:p-8 text-center">
        <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2">How can we help?</h2>
        <p className="text-xs sm:text-sm text-gray-500 mb-4 sm:mb-5">Search our documentation and FAQs</p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-5">
            ...
            <p className="text-xs text-gray-400 mt-2 text-center">Avg. response: ~2 hours</p>
          </div>
            ...
            <div className="space-y-1">
              {LINKS.map(link => (
                <a key={link.label} href={link.href} target="_blank" rel="noopener noreferrer"
                  ...
                  {link.label}
                  <ExternalLink size={12} className="text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-400" />
                </a>
              ))}
            </div>
          </div>
      ...
      {/* Docs grid */}
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-5">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">Documentation</h3>
