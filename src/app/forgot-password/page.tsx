    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900 transition-colors">
      ...
      <div className="w-full max-w-[420px] relative">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-[1.75rem] font-bold tracking-tight text-gray-900 dark:text-white">{stepTitle}</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1.5 text-center px-4">{stepSubtitle}</p>
        </div>
